...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $modal_department = new Departement(
        $_POST['name'],
        $_POST['location']
    );
    $department->updateDepartment($modal_department,$_GET['id']);
        ...
        <div class="relative p-5 border w-full max-w-md shadow-2xl rounded-2xl bg-gray-800 border-gray-600">
            <div class="mt-3">
                ...
                <form id="modalForm" method="post">
                    ...
                    <div class="mb-4"><label class="block text-gray-300 text-sm font-medium mb-2">Nom de
                            Department</label><input name="name"
                            ...
                            type="text" value="<?php echo $result['name'] ?? '' ?>"></div>
                    <div class="mb-4"><label class="block text-gray-300 text-sm font-medium mb-2">Location</label><input
                            name="location"
                            class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                            type="text" value="<?php echo $result['location'] ?? '' ?>"></div>
