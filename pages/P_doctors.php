            ...
            <div class="py-6">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-400">Bienvenue, Dr. Martin. Voici un aperçu de votre journée.</p>
                    </div>
                        ...
                        <div class="bg-gray-800 overflow-hidden shadow rounded-lg">
                            <div class="p-5">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-5 w-0 flex-1">
                                        <dl>
                                            <dt class="text-sm font-medium text-gray-400 truncate">Taux de croissance</dt>
                    ...
                    <div class="bg-gray-800 shadow rounded-lg mb-8">
                        <div class="border-b border-gray-700">
                            <nav class="flex -mb-px">
                                <button class="tab-btn py-4 px-6 text-sm font-medium text-blue-400 border-b-2 border-blue-500 focus:outline-none" data-tab="patients">
                                    Patients
                                </button>
                                ...
                                <table class="min-w-full divide-y divide-gray-700">
                                    <thead class="bg-gray-700">
                                        <tr>
                                            ...
                                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Date de naissance</th>
                                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Téléphone</th>
                                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Dernière visite</th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-gray-800 divide-y divide-gray-700">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400"><?=  $value['patient_date_of_birth']  ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400"><?=  $value['user_phone']  ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400"><?=  $value['appointment_date']  ?></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    ...
                                    <div class="flex justify-between">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <div class="text-sm text-gray-400">Consultation générale</div>
                                            </div>
                                        </div>
                                        <div class="flex items-center space-x-4">
                                    ...
                                    <div class="flex justify-between">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <div class="text-sm text-gray-400">Suivi traitement</div>
                                            </div>
                                        </div>
                                        <div class="flex items-center space-x-4">
                                            <div class="text-sm text-gray-400">
                                ...
                                <table class="min-w-full divide-y divide-gray-700">
                                    <thead class="bg-gray-700">
                                        <tr>
                                            ...
                                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Médicament</th>
                                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Dosage</th>
                                    ...
                                    <tbody class="bg-gray-800 divide-y divide-gray-700">
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400">Paracétamol</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400">500mg, 3x/jour</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400">12/05/2023</td>
                                        </tr>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-white">Marie Martin</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400">Amoxicilline</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400">1g, 2x/jour</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400">05/05/2023</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
            ...
            <div class="mt-3">
                ...
                <form class="space-y-4">
                    <div>
                        ...
                        <input type="text" class="w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-gray-900 text-white" placeholder="Nom et prénom">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-1">Date de naissance</label>
                        <input type="date" class="w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-gray-900 text-white">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-1">Téléphone</label>
                        <input type="tel" class="w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-gray-900 text-white" placeholder="06 12 34 56 78">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-1">Email</label>
                        <input type="email" class="w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-gray-900 text-white" placeholder="email@example.com">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-1">Adresse</label>
                        <textarea class="w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-gray-900 text-white" rows="3" placeholder="Adresse complète"></textarea>
                    </div>
                    <div class="flex justify-end space-x-3 pt-4">
                        <button type="button" id="cancel-patient-modal" class="px-4 py-2 bg-gray-700 text-gray-300 rounded-md hover:bg-gray-600 focus:outline-none">
                            Annuler
                        </button>
        ...
        <div class="mt-3">
            ...
            <form class="space-y-4">
                <div>
                    ...
                    <select class="w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-gray-900 text-white">
                ...
                <div>
                    ...
                    <input type="time" class="w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-gray-900 text-white">
                </div>
                <div>
                ...
                <div>
                    ...
                    <textarea class="w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-gray-900 text-white" rows="3" placeholder="Notes supplémentaires"></textarea>
                </div>
                <div class="flex justify-end space-x-3 pt-4">
                    <button type="button" id="cancel-appointment-modal" class="px-4 py-2 bg-gray-700 text-gray-300 rounded-md hover:bg-gray-600 focus:outline-none">
                        Annuler
                    </button>
                    <button type="button" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none">
                        Créer
...
<div id="add-prescription-modal" class="modal fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden">
        ...
        <div class="mt-3">
            ...
            <form class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" class="w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-gray-900 text-white" placeholder="Nom du médicament">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-300 mb-1">Dosage</label>
                    <input type="text" class="w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-gray-900 text-white" placeholder="Ex: 500mg, 3x/jour">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-300 mb-1">Durée</label>
                    <input type="text" class="w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-gray-900 text-white" placeholder="Ex: 7 jours">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-300 mb-1">Instructions</label>
                    <textarea class="w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-gray-900 text-white" rows="3" placeholder="Instructions spéciales"></textarea>
                </div>
                <div class="flex justify-end space-x-3 pt-4">
                    <button type="button" id="cancel-prescription-modal" class="px-4 py-2 bg-gray-700 text-gray-300 rounded-md hover:bg-gray-600 focus:outline-none">
                        Annuler
                    </button>
                    <button type="button" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none">
                        Créer
    ...
    <div id="success-notification" class="fixed bottom-4 right-4 bg-green-600 text-white px-6 py-3 rounded-lg shadow-lg transform translate-y-full transition-transform duration-300 ease-in-out">
        <div class="flex items-center">
